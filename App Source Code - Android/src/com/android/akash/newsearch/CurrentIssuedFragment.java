...
public class CurrentIssuedFragment extends ListFragment {
	...
	public static final String TAG_BORROW = "borrow";
...
private class BookAdapter extends ArrayAdapter<Book>{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			// TODO Auto-generated method stub
			if(convertView == null){
				convertView = getActivity().getLayoutInflater().inflate(R.layout.fragment_current_issued, null);
			}
			...
			TextView retDate = (TextView)convertView.findViewById(R.id.return_date);
			retDate.setText("Return Date:"+b.getReturn_date());
				...
				if (result != null){
					...
					try{
							...
							for(int j = 0 ; j < books.length() ; j++){
								...
								JSONArray b = c.getJSONArray(TAG_BORROW);
								...
								for(int i = 0 ; i < b.length() ;i++){
									...
									Book book = new Book(title,author,publ,id,ret,booklate);
